...
@JsonIdentityInfo(generator = ObjectIdGenerators.PropertyGenerator.class, property = "id", scope = ShortMessageSendRecord.class)
@Entity
@Table(name = "msg_short_message_send_record")
public class ShortMessageSendRecord extends JpaEntity<Long> {
    ...
    @NotNull(message = "短信发送记录id不能为空", groups = Second.class)
    private Long id;
    ...
    @Length(message = "短信模板的长度不能超过32", max = 32)
    ...
    private ShortMessageSendStatusEnum status;
